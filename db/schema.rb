...
ActiveRecord::Schema.define(version: 2023_08_21_180744) do
  ...
  create_table "study_learning_paths", force: :cascade do |t|
    t.bigint "talent_id", null: false
    t.bigint "learning_path_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["learning_path_id"], name: "index_study_learning_paths_on_learning_path_id"
    t.index ["talent_id"], name: "index_study_learning_paths_on_talent_id"
  end
  ...
  add_foreign_key "study_learning_paths", "learning_paths"
  add_foreign_key "study_learning_paths", "talents"
